<div class="page-footer">
            ...
            <script src="assets/morris/raphael-min.js" type="text/javascript"></script>
            <script src="assets/js/counterup/jquery.waypoints.min.js" type="text/javascript"></script>
            <script src="assets/js/counterup/jquery.counterup.min.js" type="text/javascript"></script>
            ...
            <script src="assets/js/amcharts/amcharts/pie.js" type="text/javascript"></script>
            <script src="assets/js/amcharts/amcharts/radar.js" type="text/javascript"></script>
            <script src="assets/js/amcharts/amcharts/themes/light.js" type="text/javascript"></script>
            <script src="assets/js/amcharts/amcharts/themes/patterns.js" type="text/javascript"></script>
            <script src="assets/js/amcharts/amcharts/themes/chalk.js" type="text/javascript"></script>
            <script src="assets/js/amcharts/ammap/ammap.js" type="text/javascript"></script>
            <script src="assets/js/amcharts/ammap/maps/js/worldLow.js" type="text/javascript"></script>
            <script src="assets/js/amcharts/amstockcharts/amstock.js" type="text/javascript"></script -->
            <script src="assets/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
            <script src="assets/js/horizontal-timeline/horozontal-timeline.min.js" type="text/javascript"></script>
