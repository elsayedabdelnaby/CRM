@extends('layouts.app') @section('title','Forms') @section('page_name', 'Forms') @section('content') @if($form_type == 'insert')
<div class="portlet light ">
    <div class="portlet-title">
        <div class="caption font-green">
            <i class="icon-pin font-green"></i>
            <span class="caption-subject bold"> Add New Module</span>
        </div>
    </div>
    <div class="portlet-body form">
        {!! Form::model($module, array('route'=>'modules.store', 'role'=>'form', 'novalidate')) !!}
...
<div class="portlet light ">
    <div class="portlet-title">
        <div class="caption font-green">
            <i class="icon-pin font-green"></i>
            <span class="caption-subject bold"> Update Module</span>
        </div>
    </div>
    <div class="portlet-body form">
        {!! Form::model($module, array('method'=>'PATCH', 'action'=>['ModulesController@update', $module->id],'role'=>'form', 'novalidate')) !!}
        <div class="form-body row">
            <div class="col-md-1"></div>
            <div class="form-group form-md-line-input form-md-floating-label col-md-4">
                {!! Form::text('name_en', null, array('class'=>'form-control', 'id'=>'form_control_1', 'required', 'english')) !!}
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>Modules </div>
                <div class="tools"> </div>
            </div>
                ...
                <table class="table table-striped table-bordered table-hover" id="sample_2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{!! url('/modules')!!}/{{$module->id}}/edit" class="btn btn-outline btn-circle btn-sm purple">
                                    <i class="fa fa-edit"></i> Edit </a>
                                <a href="{!! url('/modules')!!}/{{$module->id}}/destroy" class="btn btn-outline btn-circle dark btn-sm black">
